...
frames(1).setProperties('rotationaxis', 3, 'rotationvar', theta(1), 'Qcoordinates', [theta(1),thetadot(1),thetaddot(1)], 'cm2joint', [0,0,0],'joint2cm',[L1/2,0,0], 'mass', 10);
frames(1).setProperties('Jmatrix', [0,0,0;0,0,0; 0,0, 10*L1^2/12]);
frames(2).setProperties('rotationaxis', 3, 'rotationvar', theta(2), 'Qcoordinates', [theta(2),thetadot(2),thetaddot(2)], 'cm2joint', [L1/2,0,0],'joint2cm',[L2/2,0,0], 'mass', 10);
frames(2).setProperties('Jmatrix', [0,0,0;0,0,0; 0,0, 10*L2^2/12]);
