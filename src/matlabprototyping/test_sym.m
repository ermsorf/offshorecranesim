...
Q = getQs(frames(noofframes),frames);
B = makeB(frames(noofframes),frames)
Bdot = makeBdot(frames(noofframes),frames)
D = makeD(frames(noofframes),frames)
M = makeM(frames(noofframes),frames)
Mstar = B' * M * B
