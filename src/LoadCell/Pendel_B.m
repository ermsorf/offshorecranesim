addpath("C:\GitHub\offshorecranesim\src\FrameGen")
...
frames(3) = Frame('framenumber',3, 'rotationaxis', 3, 'rotationvar',theta(3), 'mass', 85, 'Qcoordinates',[theta(3),thetadot(3),thetaddot(3)],'cm2joint',[0,0,0],'joint2cm',[0, 0, -30]);       % First wire segment    %Body 1