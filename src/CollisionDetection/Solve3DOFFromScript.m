...
% Equation 1:
eq1 = 12501212015*thetaddot1 + 12003*thetaddot1*cos(theta2)^2 + 24012*thetaddot1*cos(theta2) + 12500000000*thetaddot3*sin(theta2) + 12500000000*thetadot2*thetadot3*cos(theta2) + 3000000000*l^2*thetaddot1*cos(theta2)^2 + 12000000*l*thetadot1*thetadot2*sin(theta2) + 12000000*l*thetadot1*thetadot2*sin(2*theta2) == 12000000*l*thetaddot1*cos(theta2) + 24012*thetadot1*thetadot2*sin(theta2) + 12000000*l*thetaddot1*cos(theta2)^2 + 6000000*g*sin(theta1)*(cos(theta2) - 500*l*cos(theta2) + 1) + 12003*thetadot1*thetadot2*sin(2*theta2) + 3000000000*l^2*thetadot1*thetadot2*sin(2*theta2)

% Equation 2:
eq2 = (12500612003*thetaddot2)/600000 + (2001*thetadot1^2*sin(theta2))/100000 - 20*l*thetaddot2 + (4001*thetadot1^2*sin(2*theta2))/400000 + 5000*l^2*thetaddot2 + 2500*l^2*thetadot1^2*sin(2*theta2) - 10*l*thetadot1^2*sin(theta2) - 10*l*thetadot1^2*sin(2*theta2) == (62500*thetadot1*thetadot3*cos(theta2))/3 + 10*g*cos(theta1)*sin(theta2) - 5000*g*l*cos(theta1)*sin(theta2)

% Equation 3:
eq3 = thetaddot3 + thetaddot1*sin(theta2) + thetadot1*thetadot2*cos(theta2) == 0
...
%[theta3, theta3dot), theta1, theta1dot, theta2, theta2dot]
Y0 = [0, 0, 0.5, 0, 0, 0];  % example initial conditions

%% Solve the system using ode45
tspan = [0 20];  % time interval for the simulation
