...
function main_trajectory()
    ...
    % Stationary Box 1
    stationaryBoxes(1).center = [2.7654; 0; 0.324];
    ...
    for step = 1:nSteps
        ...
        for i = 1:nBoxes
            ...
            if collision
                ...
                % Fill remaining entries for this time step.
                for j = i+1:nBoxes
    ...
    animate_trajectory(movingBox, stationaryBoxes, trajectoryPositions, collisionsOverTime);
end
...
function animate_trajectory(movingBox, stationaryBoxes, trajectoryPositions, collisionsOverTime)
    figure; hold on; grid on; axis equal;
    xlabel('X'); ylabel('Y'); zlabel('Z');
    view(3);
    
    % Draw the stationary boxes (static).
    ...
    for step = 1:nSteps
        ...
        % Update trajectory line with positions up to the current step.
        set(hTrajectory, 'XData', trajectoryPositions(1,1:step), ...
                         'YData', trajectoryPositions(2,1:step), ...
                         'ZData', trajectoryPositions(3,1:step));
        % Remove previous drawing of the moving box.
        if ~isempty(hMoving)
            delete(hMoving);
        end
        % Draw the moving box at the current position.
        hMoving = draw_OBB(currentCenter, movingBox.R, movingBox.L, [0 0 1]);
        drawnow;
        pause(0.05);  % Adjust pause for desired speed of animation.
    end
    
    % Optionally, plot any collision contact points from the processed steps.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% (Static Visualization Function – optional)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
